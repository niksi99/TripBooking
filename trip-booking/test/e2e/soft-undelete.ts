...
export async function SoftUndelete_ReturnTRUE(
...
export async function SoftUndelete_ReturnError404(
    app: INestApplication<App>,
    route: string,
    mockedService: any,
    methodName: string,
...
export async function SoftUndelete_ReturnError400(
    app: INestApplication<App>,
    route: string,
    mockedService: any,
    methodName: string,
...
export async function SoftUndelete_ThrowError500(
    app: INestApplication<App>,
    route: string,
    mockedService: any,
    methodName: any
